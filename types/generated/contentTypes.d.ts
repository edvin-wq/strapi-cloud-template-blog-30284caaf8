...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.UID<'title'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    type: Schema.Attribute.Enumeration<
      ['media-room', 'restaurant', 'entertainment']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEntertainmentServicePageEntertainmentServicePage
  extends Struct.SingleTypeSchema {
  collectionName: 'entertainment_service_pages';
  info: {
    displayName: 'Entertainment Service Page';
    pluralName: 'entertainment-service-pages';
    singularName: 'entertainment-service-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::entertainment-service-page.entertainment-service-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    social_info: Schema.Attribute.Component<'site-settings.social-info', false>;
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Global Settngs'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHospitalityAndFoodServicePageHospitalityAndFoodServicePage
  extends Struct.SingleTypeSchema {
  collectionName: 'hospitality_and_food_service_pages';
  info: {
    displayName: 'Hospitality & Food Service Page';
    pluralName: 'hospitality-and-food-service-pages';
    singularName: 'hospitality-and-food-service-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hospitality-and-food-service-page.hospitality-and-food-service-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiMediaRoomPageMediaRoomPage extends Struct.SingleTypeSchema {
  collectionName: 'media_room_pages';
  info: {
    displayName: 'Media Room Page';
    pluralName: 'media-room-pages';
    singularName: 'media-room-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMeetTheLeadersPageMeetTheLeadersPage
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::meet-the-leaders-page.meet-the-leaders-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
